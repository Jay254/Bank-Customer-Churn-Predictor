...
def explain_prediction(probability, input_dict, surname):
  ...
  Your machine learning models has predicted that a customer named {surname} has a {round(probability*100,1)}% probability of churning, based on the information provided below.
  ...
  -If the customer has over a 40% risk of churning, generate a 3 sentence explanation why they are at a risk of churning
  -If the customer has less than a 40% risk of churning, generate a 3 sentence explanation why they might not be at a risk of churning
...
def make_predictions(input_df, input_dict):
  ...
  # st.write("Average Probability: {avg_probability}")
...
def generate_email(probability,input_dict, explanation,surname):
  ...
  Generate an email to the customer based on their information, asking them to stay if they are at risk of churning, of offering them incentives so that they become more loyal to the bank.
